...
func newClusterRoles(c *ComponentsV1alpha1Client, namespace string) *clusterRoles {
	return &clusterRoles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *clusterRoles) UpdateStatus(clusterRole *v1alpha1.ClusterRole) (result *v1alpha1.ClusterRole, err error) {
	result = &v1alpha1.ClusterRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterroles").
