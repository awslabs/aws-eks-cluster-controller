...
func newClusterRoleBindings(c *ComponentsV1alpha1Client, namespace string) *clusterRoleBindings {
...
func (c *clusterRoleBindings) UpdateStatus(clusterRoleBinding *v1alpha1.ClusterRoleBinding) (result *v1alpha1.ClusterRoleBinding, err error) {
	result = &v1alpha1.ClusterRoleBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterrolebindings").
