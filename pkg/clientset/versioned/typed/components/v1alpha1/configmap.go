...
func newConfigMaps(c *ComponentsV1alpha1Client, namespace string) *configMaps {
	return &configMaps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *configMaps) Get(name string, options v1.GetOptions) (result *v1alpha1.ConfigMap, err error) {
...
func (c *configMaps) List(opts v1.ListOptions) (result *v1alpha1.ConfigMapList, err error) {
...
func (c *configMaps) Create(configMap *v1alpha1.ConfigMap) (result *v1alpha1.ConfigMap, err error) {
	result = &v1alpha1.ConfigMap{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("configmaps").
...
func (c *configMaps) Update(configMap *v1alpha1.ConfigMap) (result *v1alpha1.ConfigMap, err error) {
	result = &v1alpha1.ConfigMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configmaps").
...
func (c *configMaps) UpdateStatus(configMap *v1alpha1.ConfigMap) (result *v1alpha1.ConfigMap, err error) {
	result = &v1alpha1.ConfigMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configmaps").
...
func (c *configMaps) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ConfigMap, err error) {
	result = &v1alpha1.ConfigMap{}
