...
var clusterrolebindingsResource = schema.GroupVersionResource{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Resource: "clusterrolebindings"}

var clusterrolebindingsKind = schema.GroupVersionKind{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Kind: "ClusterRoleBinding"}
...
func (c *FakeClusterRoleBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clusterrolebindingsResource, c.ns, name), &v1alpha1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) List(opts v1.ListOptions) (result *v1alpha1.ClusterRoleBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clusterrolebindingsResource, clusterrolebindingsKind, c.ns, opts), &v1alpha1.ClusterRoleBindingList{})
...
func (c *FakeClusterRoleBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(clusterrolebindingsResource, c.ns, opts))
...
func (c *FakeClusterRoleBindings) Create(clusterRoleBinding *v1alpha1.ClusterRoleBinding) (result *v1alpha1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clusterrolebindingsResource, c.ns, clusterRoleBinding), &v1alpha1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) Update(clusterRoleBinding *v1alpha1.ClusterRoleBinding) (result *v1alpha1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clusterrolebindingsResource, c.ns, clusterRoleBinding), &v1alpha1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) UpdateStatus(clusterRoleBinding *v1alpha1.ClusterRoleBinding) (*v1alpha1.ClusterRoleBinding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(clusterrolebindingsResource, "status", c.ns, clusterRoleBinding), &v1alpha1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(clusterrolebindingsResource, c.ns, name), &v1alpha1.ClusterRoleBinding{})
...
func (c *FakeClusterRoleBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(clusterrolebindingsResource, c.ns, listOptions)
...
func (c *FakeClusterRoleBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clusterrolebindingsResource, c.ns, name, data, subresources...), &v1alpha1.ClusterRoleBinding{})
