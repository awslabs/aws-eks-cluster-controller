...
var configmapsResource = schema.GroupVersionResource{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Resource: "configmaps"}

var configmapsKind = schema.GroupVersionKind{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Kind: "ConfigMap"}
...
func (c *FakeConfigMaps) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ConfigMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(configmapsResource, c.ns, name, data, subresources...), &v1alpha1.ConfigMap{})
