...
var customresourcedefinitionsResource = schema.GroupVersionResource{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Resource: "customresourcedefinitions"}

var customresourcedefinitionsKind = schema.GroupVersionKind{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Kind: "CustomResourceDefinition"}
...
func (c *FakeCustomResourceDefinitions) Get(name string, options v1.GetOptions) (result *v1alpha1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(customresourcedefinitionsResource, c.ns, name), &v1alpha1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) List(opts v1.ListOptions) (result *v1alpha1.CustomResourceDefinitionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(customresourcedefinitionsResource, customresourcedefinitionsKind, c.ns, opts), &v1alpha1.CustomResourceDefinitionList{})
	...
	list := &v1alpha1.CustomResourceDefinitionList{ListMeta: obj.(*v1alpha1.CustomResourceDefinitionList).ListMeta}
...
func (c *FakeCustomResourceDefinitions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(customresourcedefinitionsResource, c.ns, opts))
...
func (c *FakeCustomResourceDefinitions) Create(customResourceDefinition *v1alpha1.CustomResourceDefinition) (result *v1alpha1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(customresourcedefinitionsResource, c.ns, customResourceDefinition), &v1alpha1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) Update(customResourceDefinition *v1alpha1.CustomResourceDefinition) (result *v1alpha1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(customresourcedefinitionsResource, c.ns, customResourceDefinition), &v1alpha1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) UpdateStatus(customResourceDefinition *v1alpha1.CustomResourceDefinition) (*v1alpha1.CustomResourceDefinition, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(customresourcedefinitionsResource, "status", c.ns, customResourceDefinition), &v1alpha1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(customresourcedefinitionsResource, c.ns, name), &v1alpha1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(customresourcedefinitionsResource, c.ns, listOptions)
...
func (c *FakeCustomResourceDefinitions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(customresourcedefinitionsResource, c.ns, name, data, subresources...), &v1alpha1.CustomResourceDefinition{})
