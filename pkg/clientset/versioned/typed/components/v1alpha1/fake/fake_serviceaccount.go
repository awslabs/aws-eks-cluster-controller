...
var serviceaccountsResource = schema.GroupVersionResource{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Resource: "serviceaccounts"}

var serviceaccountsKind = schema.GroupVersionKind{Group: "components.eks.amazonaws.com", Version: "v1alpha1", Kind: "ServiceAccount"}
...
func (c *FakeServiceAccounts) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(serviceaccountsResource, c.ns, name), &v1alpha1.ServiceAccount{})
...
func (c *FakeServiceAccounts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceAccount, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(serviceaccountsResource, c.ns, name, data, subresources...), &v1alpha1.ServiceAccount{})
