...
func newNamespaces(c *ComponentsV1alpha1Client, namespace string) *namespaces {
	return &namespaces{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *namespaces) Get(name string, options v1.GetOptions) (result *v1alpha1.Namespace, err error) {
...
func (c *namespaces) List(opts v1.ListOptions) (result *v1alpha1.NamespaceList, err error) {
...
func (c *namespaces) Create(namespace *v1alpha1.Namespace) (result *v1alpha1.Namespace, err error) {
	result = &v1alpha1.Namespace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("namespaces").
...
func (c *namespaces) Update(namespace *v1alpha1.Namespace) (result *v1alpha1.Namespace, err error) {
	result = &v1alpha1.Namespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namespaces").
...
func (c *namespaces) UpdateStatus(namespace *v1alpha1.Namespace) (result *v1alpha1.Namespace, err error) {
	result = &v1alpha1.Namespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namespaces").
...
func (c *namespaces) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Namespace, err error) {
	result = &v1alpha1.Namespace{}
