...
func newServiceAccounts(c *ComponentsV1alpha1Client, namespace string) *serviceAccounts {
...
func (c *serviceAccounts) List(opts v1.ListOptions) (result *v1alpha1.ServiceAccountList, err error) {
