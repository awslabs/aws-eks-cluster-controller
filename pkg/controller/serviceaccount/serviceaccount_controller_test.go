...
var expectedRequest = reconcile.Request{NamespacedName: types.NamespacedName{Name: "foo-sa", Namespace: "default"}}
var saKey = types.NamespacedName{Name: "foo-sa", Namespace: "default"}
var rsaKey = types.NamespacedName{Name: "remote-foo-sa", Namespace: "default"}
...
func TestReconcile(t *testing.T) {
	...
	instance := &componentsv1alpha1.ServiceAccount{
		ObjectMeta: metav1.ObjectMeta{Name: "foo-sa", Namespace: "default"},
		Spec:       componentsv1alpha1.ServiceAccountSpec{Cluster: "foo-eks", Name: "remote-foo-sa", Namespace: "default"},
	}
	...
	// Create the ServiceAccount object and expect the Reconcile and Deployment to be created
	...
	rSa := &corev1.ServiceAccount{}
	err = c.Get(context.TODO(), rsaKey, rSa)
	g.Expect(err).NotTo(gomega.HaveOccurred())

	sa := &componentsv1alpha1.ServiceAccount{}
	g.Eventually(func() (string, error) {
		err := c.Get(context.TODO(), saKey, sa)
		return sa.Status.Status, err
